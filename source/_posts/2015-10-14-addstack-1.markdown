...
The first series start here: [Intro](/blog/add-1/) and ends here: [Voilà!](/blog/add-11/).  The bulk of the
...
bad your job is (but google "Worst Jobs" to see you don't have it so bad).  But you are not allowed to say that _your customer_
shouldn't be 100% happy... or at least as happy as you can make them.
...
tests and our QA verification servers happy.  We are going to make them _more_ happy than our customer and _before_
we make our customer happy.
